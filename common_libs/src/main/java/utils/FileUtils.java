...
import data.DownloadFileRequest;
import data.OnDownloadListener;
...
public class FileUtils {
     ...
     * @param fileName
     */
    public static void downLoadOpenFile(Activity context, String downloadUrl, final String fileName) {
        new DownloadFileRequest(context).fileDownload(downloadUrl, fileName, new OnDownloadListener() {
            @Override
