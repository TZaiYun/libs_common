...
public class SharedPreferenceUtil {
    ...
    public static void save(String fileKey, String key, Object saveObject) throws IOException {
        SharedPreferences sharedPreferences = Utils.getApp().getSharedPreferences(fileKey, Activity.MODE_PRIVATE);
    ...
    public static Object get(String fileKey, String key) {
        SharedPreferences sharedPreferences = Utils.getApp().getApplicationContext().getSharedPreferences(fileKey, Activity.MODE_PRIVATE);
