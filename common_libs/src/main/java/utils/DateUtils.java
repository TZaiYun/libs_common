...
public class DateUtils {
    ...
    /**
     * 把040951格式的时间转成04:09:51
     *
     * @return
     */
    public static String changeTimeType(String timeString) {
        if (TextUtils.isEmpty(timeString)) {
            return "";
        } else if (4 == timeString.length()) {
            return timeString.subSequence(0, 2) + ":" + timeString.substring(2);
        } else {
            return timeString.subSequence(0, 2) + ":" + timeString.substring(2, 4) + ":" + timeString.substring(4);
        }
    }
     ...
     * @return
     */
    public static String getNearDate(String time, int distanceDay) {
     ...
     * @return
     */
    public static String getOldDateMM(int distanceDay) {
     ...
     * @return
     */
    public static String getOldDateMM24(int distanceDay) {
        SimpleDateFormat dft = new SimpleDateFormat("yyyy-MM-dd HH:mm");
        Date beginDate = new Date();
        Calendar date = Calendar.getInstance();
        date.setTime(beginDate);
